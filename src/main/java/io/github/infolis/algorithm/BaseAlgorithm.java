...
public abstract class BaseAlgorithm implements Algorithm {
    ...
    /**
	 * Add this tag to all entities generated by this algorithm.
	 */
    ...
    public final void run() {
        ...
        try {
        	String executionTag = getExecutionTag();
        	if (!executionTag.isEmpty()) getExecution().getTags().add(executionTag);
