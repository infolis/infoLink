...
public class CommandLineExecuter {
    ...
    // TODO: any better solution? e.g. to indicate the strategy as method
    // parameter?
    ...
    @Option(name = "--input-dir", usage = "Directory containing *.pdf", metaVar = "INPUTDIR", required = true)
    ...
    public void parseJson() throws FileNotFoundException, ClassNotFoundException, NoSuchFieldException, IllegalAccessException, IOException {
        ...
        // inputFiles need to be handled as a special case since we need to
        // create the
     ...
     * @return
     */
    private String checkJsonFile(JsonObject o) {
        for (Entry<String, JsonValue> values : o.entrySet()) {
            try {
