...
public class Reliability {
     ...
     * @return
     */
    public int[] countInstanceAndJointOccurrences(Map<String, Set<StudyContext>> contexts_seeds, String regex, String instance) {
    	Set<StudyContext> contextsOfSeed = contexts_seeds.get(instance);
    	int instanceCount = contextsOfSeed.size();
    	int jointOccurrences = 0;
    	for (StudyContext sc : contextsOfSeed) {
     ...
     */
    public double computePmi(int patternCount, int dataSize, Map<String, Set<StudyContext>> contexts_seeds, String regex, String instance) {
     ...
     */
    public double computeReliability(List<String> contexts_pattern, int dataSize, Set<String> reliableInstances, Map<String, Set<StudyContext>> contexts_seeds, InfolisPattern pattern) {
