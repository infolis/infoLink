...
public class Reliability {
     ...
     * @return
     */
    public int[] countInstanceAndJointOccurrences(Map<String, Set<TextualReference>> contexts_seeds, String regex, String instance) {
    	Set<TextualReference> contextsOfSeed = contexts_seeds.get(instance);
    	int instanceCount = contextsOfSeed.size();
    	int jointOccurrences = 0;
    	for (TextualReference sc : contextsOfSeed) {
    ...
    public int[] countPatternAndJointOccurrences(Set<TextualReference> contexts_patterns, String regex, String instance) {
    	int patternCount = 0;
    	int jointOccurrences = 0;
    	
    	for (TextualReference sc : contexts_patterns) {
    		Pattern p = Pattern.compile(regex);
            Matcher m = p.matcher(sc.toString());
            if (m.find()) {
            	patternCount++;
     ...
     */
    public double computePmi(int patternCount, int dataSize, Map<String, Set<TextualReference>> contexts_seeds, String regex, String instance) {
    	log.debug("computing pmi of pattern \"" + regex + "\" and instance \"" + instance + "\"");
     ...
     * @return					point-wise mutual information score of instance and pattern (belonging to regex)
     */
    public double computePmi_instance(int instanceCount, int dataSize, Set<TextualReference> contexts_patterns, String minimalRegex, String instance) {
    	log.debug("computing pmi of instance \"" + instance + "\" and pattern \"" + minimalRegex + "\"");
     ...
     */
    public double computeReliability(List<String> contexts_pattern, int dataSize, Set<String> reliableInstances, Map<String, Set<TextualReference>> contexts_seeds, InfolisPattern pattern) {
     ...
     */
    public double computeReliability(Set<TextualReference> contexts_patterns, int dataSize, Set<String> reliablePatterns, Map<String, Set<TextualReference>> contexts_seeds, Instance instance) {
