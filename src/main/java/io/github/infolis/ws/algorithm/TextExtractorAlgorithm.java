    ...
    public InfolisFile extract(InfolisFile inFile) {
        ...
        try {//check whether the bibliography shpuld be reomoved
            if (getExecution().isRemoveBib()) {
                /**
                 * Compute the ratio of numbers on page: a high number of
                 * numbers is assumed to be typical for bibliographies as they
                 * contain many years, page numbers and dates.*
                 */
