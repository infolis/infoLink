...
public class MetaDataExtractorTest extends InfolisBaseTest {
    ...
    public void testExtractMetadata() {
        ...
        assertEquals("1996/08", entity.getNumber());
        ...
        assertEquals("1982   -   1983", entity.getNumber());
        ...
        assertEquals("85/01", entity.getNumber());
        ...
        assertEquals("1982 till 1983", entity.getNumber());
        ...
        assertEquals("1982 to 1983", entity.getNumber());
        ...
        assertEquals("1982 bis 1983", entity.getNumber());
        ...
        assertEquals("1982 und 1983", entity.getNumber());
        ...
        assertEquals("1982 and 1983", entity.getNumber());
